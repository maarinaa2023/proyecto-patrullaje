...
: bt_patrol::BtActionNode<nav2_msgs::action::NavigateToPose>(xml_tag_name, action_name, conf)
{
}
...
BT_REGISTER_NODES(factory)
{
  BT::NodeBuilder builder =
    ...
    {
      return std::make_unique<bt_patrol::Move>(
        name, "navigate_to_pose", config);
    };

  factory.registerBuilder<bt_patrol::Move>(
    "Move", builder);
}
